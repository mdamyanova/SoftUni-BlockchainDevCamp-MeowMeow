...
<main>
    <div class="animated fadeIn text-center">
        Meow is a cute, friendly web platform for adopting cats from voluntary organizations.
        In MeowMeow you can adopt a kitty and give it love, care and such nice things.
        The project is build on Ethereum blockchain, using Cat smart contract. MeowMeow has it's own token called MEOW
        which is not in use yet. MeowMeow is still growing, so keep in touch!
    </div>
</main>
<footer>
